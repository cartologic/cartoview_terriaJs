...
1. Clone this repository inside the pre-installed cartoview, apps directory (e.g. `installed-cartoview/apps/`) with the name **TerriaMap**.
    ```shell
    git clone https://github.com/cartologic/cartoview_terriaJs.git TerriaMap
    ```
