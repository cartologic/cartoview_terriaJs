...
var terriaOptions = {
    baseUrl: '/static/terria_map/wwwroot/build/TerriaJS'
};
...
module.exports = terria.start({
    ...
    configUrl: '/static/terria_map/wwwroot/config.json',
    ...
    try {
        ...
        var allBaseMaps = createGlobalBaseMapOptions(terria, terria.configParameters.bingMapsKey);
